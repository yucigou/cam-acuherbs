...
const AboutDocter = () => {
    ...
    <MainSection>
      ...
      <div class='embed-container'><iframe src='https://www.youtube.com/embed/4NuojGmHqaE' frameborder='0' allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
    </MainSection>
  )
}
